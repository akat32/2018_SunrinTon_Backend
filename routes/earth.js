...
module.exports = (router, request)=>{
  router.post('/', async (req,res)=>{
    var apiurl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?region=kr&location=" + req.body.x + "," + req.body.y + "&radius=1000&type=school&key=AIzaSyC0WvUEVSxSbcLhUw_ndmcLhf2_HkuDs5c";
